...
from utils.model_euclidean import EuclideanManifold, DistanceEnergyFunction, RiemannianSGD
...
class EuclideanDataset(Dataset):
    ...
    def create_sample(self):
        ...
        for sequence in tqdm(sequenceList, desc="Sampling Negative Samples"):
            ...
            self.samples.extend(
                [
                    (u, v, self.data.getNegatives(u, v, self.nneg))
...
class EuclideanEmbedding:
    def __init__(
        ...
        dataset = EuclideanDataset(self.data, window_size, nneg)
